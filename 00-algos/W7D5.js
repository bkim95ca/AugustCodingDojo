 ...
 class BSTNode {
  ...
  height(node = this.root) {
    if (!node){
        ...
        if (lHeight > rHeight) {
            return (lHeight + 1); //this.height(node.left) + 1
        } else {
            return (rHeight + 1); //this.height(node.right) + 1
        }
    }
}
...
//   console.log(fullThreeLevelTree.size());
console.log(fullThreeLevelTree.height());
// console.log(threeLevelTree.isFull());
// console.log(fullThreeLevelTree.isFull());
